...
class Ecliptic:
    ...
    def get_depsilon_low(self):
        """ dEpsilon accurate to 0.1" as an Angle object"""
        return Angle(self.d_epsilon_low)
...
if __name__ == "__main__":
    ...
    print 'Ecliptic J2000:', ecliptic_j2k.get_obliquity_uncorrected() # 23deg26'21.448"
    print 'Ecliptic J2000 (corrected):', ecliptic_j2k.get_obliquity_corrected() # 23deg 26'15.69"
